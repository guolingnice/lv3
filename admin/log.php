    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse" >
            <ul class="nav nav-pills navbar-nav navbar-right">
                ...
                <li><a href="log.php" class="active"><span class="glyphicon glyphicon-list-alt"></span> 操作日志</a></li>
    ...
    <div class="col-xs-12 col-sm-10 col-lg-8 center-block" style="float: none;">
        <div class="panel panel-primary">
           <div class="panel-heading">
                <h3 class="panel-title">管理员操作记录</h3>
            </div>
            <div class="panel-body">
                 <table class="layui-hide" id="admin_log" lay-filter="admin_log"></table>
            </div>
        </div>
    </div>
</div>
...
function admin_log(){
 table.render({
    ...
    ,cols: [[
      ...
      ,{field:'user', width:110, title: '操作用户'}
      ,{field:'type', title:'操作类型 ', width:120}
      ,{field:'data', title:'操作内容 ', width:200}
      ,{field:'city', title:'操作城市 ', width:160}
      ,{field:'ip', title:'操作IP ', width:130} 
      ,{field:'time', title:'操作时间', width: 165}
    ]]
    ,done: function(){
      var id = this.id;
